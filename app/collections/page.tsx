    ...
    <div className="grid grid-cols-5 gap-4">
      ...
      <div className="col-start-1 col-end-5 w-auto relative opacity-90 ml-20">
        ...
        {squareImages?.map((image) => {
          ...
          <ImageContainer src={image?.src} alt={image?.alt} rounded width={150.32} height={150}/>
          </div>
        )
        })
        }
        ...
        <div className='grid grid-cols-1 gap-12'>
      {
        rightImages?.map((image)=>{
          return(
            <div className='hover:scale-125'>
            <ImageContainer src={image?.src} alt={image?.alt} rounded width={160} height={200}/>
            </div>
          )
        })
      }
      ...
      <div className='grid grid-cols-3 gap-8 mt-8'>
        {
          bottomImages?.map((image)=>{
            return(
              <div className='hover:scale-125'>
              <ImageContainer src={image?.src} alt={image?.alt} rounded width={200} height={150}/>
              </div>
            )
          })
        }
